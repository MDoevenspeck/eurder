...
public enum Role {
    ADMIN(Feature.CREATE_ADMIN, Feature.GET_ALL_USERS_BY_USERTYPE, Feature.GET_ALL_USERS,
            ...
            Feature.GET_ALL_ITEMS_BY_STOCK_LEVEL, Feature.GET_ALL_ITEMS_SORTED_BY_STOCK_LEVEL,
            Feature.CREATE_ORDER, Feature.GET_ALL_ORDERS_BY_CUSTOMER_ID, Feature.GET_ALL_ORDERS),
